  ...
  return (
    ...
    <section className="footer">
        <div className="box-container">
          <div className="box">
            <h3>Address</h3>
            <a href="googlemaplink">Phagwara, Punjab</a>
        ...
        <div className="box">
            <h3>Contact Us </h3>
                ...
                <i className="fa">
                <a href="tel:+91 6204286169">+91 1234567890 </a></i>  
                <br></br>
                <i className="fa">
                <a href="mailto:info.iamnitish1707@gmail.com">iamnitish1707@gmail.com</a></i>
            </div>
        <div className="box">
            <h3>Follow us</h3>
            <link
    ...
    <div className="credits">
        <p>© 2023 Nitish. All Rights Reserved.</p>
      </div>
    </div>
    </>
  );
